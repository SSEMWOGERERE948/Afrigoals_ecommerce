...
export const searchProductsTool = tool({
  description:
    "Search for products in the sports merchandise store. Can search by name, description, or category, and filter by material, color, and price range. Returns product details including stock availability.",
